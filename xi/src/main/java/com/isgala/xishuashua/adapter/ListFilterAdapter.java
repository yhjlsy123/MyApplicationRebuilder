...
public class ListFilterAdapter extends BAdapter<BathRoomFilter.Filter> {
    public ListFilterAdapter(List<BathRoomFilter.Filter> list, int layoutId, Context context, String b_id) {
    ...
    public void upDateView(int position, ViewHolder holder, BathRoomFilter.Filter item) {
        ...
        leftTextView.setText(item.name);
