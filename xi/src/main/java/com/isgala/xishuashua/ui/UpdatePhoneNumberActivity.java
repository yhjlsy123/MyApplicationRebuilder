...
import static com.isgala.xishuashua.api.Neturl.EDIT_MOBILE;
...
public class UpdatePhoneNumberActivity extends BaseAutoActivity {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.login_enter:
                ...
                String updatephone=update_phone.getText().toString();
                ...
                if (NetworkUtil.isNetworkAvailable()) {
                    ...
                    updatePhone(mPhoneNum, mVerificationCode,updatephone);
                }
                loginEnter.setClickable(true);
                break;
     ...
     */
    private void updatePhone(String phoneNum, String verificationCode,final String newPhone) {
        SPUtils.saveString("balance", "");//初始化保存在本地的余额记录
        Map<String, String> params = new HashMap<String, String>();

        params.put("oauth_token", SPUtils.getString(Constants.OAUTH_TOKEN, ""));
        params.put("oauth_token_secret",  SPUtils.getString(Constants.OAUTH_TOKEN_SECRET, ""));
        params.put("uuid", SPUtils.getString("uuid", ""));//唯一设备标识
        params.put("mobile",newPhone);//新手机号码
        params.put("old_mobile", phoneNum );//旧手机号码
        params.put("vrcode", verificationCode);//验证码
        params.put("type", "mobile");//手机验证码类型，默认为‘mobile’，代表更换手机号

        LogUtils.e(TAG, params.toString());
        VolleySingleton.postNoDEVICETOKEN(EDIT_MOBILE, "edit_mobile", params, new VolleySingleton.CBack() {
            @Override
...
//        SPUtils.saveString(Constants.LOCATON_LNG, "");
    ...
    public void showContacts() {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION)
            ...
            ActivityCompat.requestPermissions(UpdatePhoneNumberActivity.this, new String[]{Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.READ_PHONE_STATE}, 100);
        } else {
            requestLocation();
        }
    }
