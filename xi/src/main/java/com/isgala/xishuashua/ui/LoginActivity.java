...
public class LoginActivity extends BaseAutoActivity {
    ...
    @OnClick({R.id.login_code, R.id.login_enter, R.id.shiyongshuoming,R.id.message_back})
    ...
    private void login(String phoneNum, String verificationCode) {
        ...
        params.put("vrcode", verificationCode);
        ...
        VolleySingleton.postNoDEVICETOKEN(USER_LOGIN, "login", params, new VolleySingleton.CBack() {
            @Override
            public void runUI(String result) {
//                LogUtils.e(TAG, " login : " + result);
    ...
    private void jump(LoginResult.DataBean data) {
        ...
        SPUtils.saveString(Constants.PHONE_NUMBER,data.phone);
        Class nClass;
...
//        SPUtils.saveString(Constants.LOCATON_LNG, "");
    ...
    public void showContacts() {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION)
            ...
            ActivityCompat.requestPermissions(LoginActivity.this, new String[]{Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.READ_PHONE_STATE}, 100);
        } else {
            requestLocation();
        }
    }
