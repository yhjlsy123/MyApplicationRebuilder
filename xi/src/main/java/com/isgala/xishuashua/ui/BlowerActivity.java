...
import com.isgala.xishuashua.adapter.BlowerListAdapter;
import com.isgala.xishuashua.adapter.ListBlowerAdapter;
...
import static com.isgala.xishuashua.api.Neturl.BEGIN_BLOWER;
import static com.isgala.xishuashua.api.Neturl.SHOW_BLOWER_DEVICE;
        ...
        VolleySingleton.post(BEGIN_BLOWER, "begin_blower", startMap, new VolleySingleton.CBack() {
            ...
            public void runUI(String result) {
                ...
                if (resultBean != null && resultBean.data != null) {
                    ToastUtils.show(resultBean.data.tip);
                    update();
                }
            }
        });
