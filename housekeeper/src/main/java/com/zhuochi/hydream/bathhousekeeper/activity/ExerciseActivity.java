...
import com.zhuochi.hydream.bathhousekeeper.adapter.ActivityListAdapter;
...
import com.zhuochi.hydream.bathhousekeeper.view.SwipeItemLayout;
 ...
 * 活动管理
 */
public class ExerciseActivity extends BaseActivity implements HeightSelectView.SelcetCallBack {
    ...
    private ArrayList<ActivityEntity> mDataList;
    private int delPos;
...
//        });
        ...
        adapter = new ActivityListAdapter(R.layout.item_exercise, mDataList);
        ...
        OnItemSwipeListener onItemSwipeListener = new OnItemSwipeListener() {
            ...
            public void onItemSwipeStart(RecyclerView.ViewHolder viewHolder, int pos) {
                delPos = pos;
                delAcitivity(mDataList.get(pos).getActivity_id() + "");
...
//        }, recyclerView);
    ...
    private void loadDataFromNet() {
        ...
        params.getActivityList(SPUtils.getInt(Constants.USER_ID, 0), org_id, org_area_id, startTime, endTime);
    }


    /*删除活动*/
    private void delAcitivity(String activity_id) {
        params.addCallBack(this);
        ...
        params.comnRequest("Activity/del", data);
    }
    ...
    public void onRequestSuccess(String tag, SonBaseEntity result) {
        ...
        switch (tag) {
            case "lists":
                ...
                if (jsonArray.size() > 0) {
                    List<ActivityEntity> entity = JSON.parseArray(JSON.toJSONString(jsonArray), ActivityEntity.class);
