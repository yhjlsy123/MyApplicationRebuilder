...
public class ReplyListsActivity extends BaseActivity {
...
//        highApiEffects();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.line_addfeedback:
                Intent intent = new Intent(this, FeedReplyActivity.class);
    ...
    private class MyFeedBackAdater extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            } else if (entities.get(position).getSource_type().equals("admin") || entities.get(position).getSource_type().equals("store")) {
