package com.zhuochi.hydream.view.pickerView.lib;
...
import com.zhuochi.hydream.view.pickerView.adapter.WheelAdapter;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.dp15);
