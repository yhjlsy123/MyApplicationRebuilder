...
public class LoadingSpecialDialog extends Dialog {
    ...
    private static LoadingSpecialDialog dialog;

    public LoadingSpecialDialog(Context context) {
        super(context);
    }

    public LoadingSpecialDialog(Context context, int theme) {
        super(context, theme);
    }

    public LoadingSpecialDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    public static class Builder {
        ...
        public LoadingSpecialDialog create() {
            // 使用Theme实例化Dialog
            dialog = new LoadingSpecialDialog(mActivity, R.style.LoadingAnimDialog_translucent);
