...
public class ServicingFragment extends BaseHomeFragment {
    ...
    private View mView;
    private TextView servingLocation, servingTime, servingMoney, servingPwd, wait_bathroomlocation;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.fragment_servicing, null);
...
//        Bundle arguments = getArguments();
        ...
        wait_bathroomlocation = (TextView) mView.findViewById(R.id.wait_bathroomlocation);
...
//        LoadingTrAnimDialog.dismissLoadingAnimDialog();
    ...
    public void upView(Bundle bundle) {
        ...
        wait_bathroomlocation.setText(deviceName);
